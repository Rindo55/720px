...
async def gg():
        cmd = '''ffmpeg -hide_banner -loglevel quiet -progress "progressaa.txt" -i "video.mkv" -c:v h264 -s 256x144 -preset veryfast -r 24000/1001 -crf 32 -c:a aac -b:a 80k "out.mkv" -y''',
